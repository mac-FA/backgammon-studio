...
Eine neue statische Backgammon-Web-App mit großem, stabilem Brett, lokaler Zwei-Spieler-Bedienung und optionalem Computergegner.

## Start

Öffne `index.html` direkt im Browser oder hoste den Ordner per GitHub Pages.

## Enthalten

- Komplettes lokales Backgammon mit Bar, Schlagen und Ausspielen
